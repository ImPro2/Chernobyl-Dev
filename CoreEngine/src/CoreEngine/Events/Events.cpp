...
namespace CH {
	...
	int Event::s_CurrentSysKeyDown = CH_KEY_UNKNOWN;
	int Event::s_CurrentSysKeyUp   = CH_KEY_UNKNOWN;
	...
	void Event::Clear()
	{
		...
		s_CurrentSysKeyDown = CH_KEY_UNKNOWN;
		s_CurrentSysKeyUp = CH_KEY_UNKNOWN;
